  ...
  END;
   ...
   VAR TotalX,TotalO,I:INTEGER;
      BEGIN
         ...
         {Total of 8 win conditions for each player}

         {X conditions}

         IF (FillArray[1,1]='X') AND
            (FillArray[1,2]='X') AND
            (FillArray[1,3]='X') THEN Outcome:='Player 1 Wins';

         IF (FillArray[2,1]='X') AND
            (FillArray[2,2]='X') AND
            (FillArray[2,3]='X') THEN Outcome:='Player 1 Wins';

         IF (FillArray[3,1]='X') AND
            (FillArray[3,2]='X') AND
            (FillArray[3,3]='X') THEN Outcome:='Player 1 Wins';

         IF (FillArray[1,1]='X') AND
            (FillArray[2,1]='X') AND
            (FillArray[3,1]='X') THEN Outcome:='Player 1 Wins';

         IF (FillArray[1,2]='X') AND
            (FillArray[2,2]='X') AND
            (FillArray[3,2]='X') THEN Outcome:='Player 1 Wins';

         IF (FillArray[1,3]='X') AND
            (FillArray[2,2]='X') AND
            (FillArray[3,3]='X') THEN Outcome:='Player 1 Wins';
         ...
         IF (FillArray[1,1]='O') AND
            (FillArray[1,2]='O') AND
            (FillArray[1,3]='O') THEN Outcome:='Player 2 Wins';

         IF (FillArray[2,1]='O') AND
            (FillArray[2,2]='O') AND
            (FillArray[2,3]='O') THEN Outcome:='Player 2 Wins';

         IF (FillArray[3,1]='O') AND
            (FillArray[3,2]='O') AND
            (FillArray[3,3]='O') THEN Outcome:='Player 2 Wins';

         IF (FillArray[1,1]='O') AND
            (FillArray[2,1]='O') AND
            (FillArray[3,1]='O') THEN Outcome:='Player 2 Wins';

         IF (FillArray[1,2]='O') AND
            (FillArray[2,2]='O') AND
            (FillArray[3,2]='O') THEN Outcome:='Player 2 Wins';

         IF (FillArray[1,3]='O') AND
            (FillArray[2,2]='O') AND
            (FillArray[3,3]='O') THEN Outcome:='Player 2 Wins';
