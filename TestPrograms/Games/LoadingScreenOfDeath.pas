...
DELAY(4000);
WRITELN;
WRITELN('No, let me think. 00010F24...');
DELAY(2000);
WRITELN;
WRITELN('Wait a minute.');
DELAY(1000);
WRITELN;
WRITELN('Where the hell was that?');
DELAY(1000);
WRITELN;
WRITELN('Yeah, found: 00020EFF.');
DELAY(1500);
WRITELN;
WRITELN('Damn it, we`ve lost it again. Searching......');
DELAY(2000);
WRITELN;
WRITELN('Wanna play tic tac toe? Y/N');
Z:=UPCASE(READKEY);
IF Z<>'Y' THEN BEGIN
WRITELN;
WRITELN('Are you sure? I really would reconsider if I were you... Y/N');
Z:=UPCASE(READKEY);
IF Z<>'Y' THEN BEGIN
WRITELN;
WRITELN('Suit yourself, have fun ',#1);
DELAY(2000);
CLRSCR;
END;
END;
